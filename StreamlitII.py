...
def main():
    ...
    st.set_page_config(page_title = 'Telemarketing analisys', \
        page_icon = r"C:\Users\joao3\Documents\Jupyter Notebook - Projetos\EBAC\Módulo 19\img\telmarketing_icon.png",
        layout="wide",
    ...
    image = Image.open(r"C:\Users\joao3\Documents\Jupyter Notebook - Projetos\EBAC\Módulo 19\img\Bank-Branding.jpg")
    ...
    if (data_file_1 is not None):
        ...
        bank_raw_target_perc = (bank_raw['y'].value_counts(normalize=True) * 100).reset_index().rename(columns={'index': 'y'})
        bank_raw_target_perc = bank_raw_target_perc.sort_index()
        
        try:
            bank_target_perc = (bank['y'].value_counts(normalize=True) * 100).reset_index().rename(columns={'index': 'y'})
        ...
        if graph_type == 'Barras':
            sns.barplot(x = bank_raw_target_perc.proportion, 
                        y = 'y',
            ...
            sns.barplot(x = bank_target_perc.proportion, 
                        y = 'y', 
